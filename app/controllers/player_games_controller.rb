class PlayerGamesController < ApplicationController
  ...
  private
    ...
    def player_game_params
      params.require(:player_game).permit(:player_id, :team_id, :date, :opponent_id, :minutes_played, :fg, :fga, :fgp, :threep, :threepa, :threepp, :ft, :fta, :ftp, :orb, :drb, :trb, :ast, :stl, :blk, :tov, :pf, :pts)
    end
end
